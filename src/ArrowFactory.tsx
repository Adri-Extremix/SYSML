      ...
      return <svg style={{ position: 'absolute', top: 0, left: 0 }}>
        <defs>
          ...
          <marker
            ...
            refY={40}
          >
					 <path d="M4.386 2.249H.357" fill="none" stroke="#64669b" stroke-width=".2645625" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="3.9" stroke-dasharray="none" stroke-dashoffset=".4545" stroke-opacity="1" transform="translate(-.224 -.018)"/>
					 <path d="M4.228 2.235 2.18 1.401m2.048.834-2.048.833" fill="none" stroke="#64669b" stroke-width=".264562" stroke-linecap="butt" stroke-linejoin="round" stroke-miterlimit="4" stroke-dasharray="none" stroke-opacity="1"/>
        </marker> </defs> </svg>
		  },
		  Arrow : () => {
					 ...
					 // <path d="m4.052 3.37-.364-.03.208-.3Z" style=fill="#64669b" fill-opacity="1" stroke-width=".303001" stroke-linecap="square" stroke-miterlimit="3.9" stroke-dasharray="none" stroke-dashoffset="1.7178" transform="matrix(1.33713 -.55363 .91924 .8271 -3.887 1.693)"/>
}
export default ArrowFactory
