    ...
    const handleDoubleClick = (e: React.MouseEvent<HTMLElement>) => {
        ...
        setEditData({
            ...
            compartments: data.compartments
                ? JSON.parse(JSON.stringify(data.compartments))
                : [],
        });
        setIsEditing(true);
    };
                ...
                data.compartments.map((comp, index) => (
                    <div
                        ...
                        style={{
                            ...
                            borderBottom:
                                index < data.compartments.length - 1
                                    ? "1px solid #333"
                                    : "none",
                            textAlign: "left",
                        }}
